...
<script type="text/javascript">
    function myOnClickbrk(ctrl){
       var cart = ctrl.getElementsByTagName('p')[0].innerHTML;
        alert('Confirm Cart?');
        window.location.href = "shop_kid_cart.php?shopkid_cart=" + cart;
...
?>
    ...
    <head>
        <title>rannaghra/shop/Kids</title>
        ...
        <section>
            <div class="wrapper">
              ...
              <div class="col-12 col-m6 col-l3 header_bottom_height">
                  ...
                  <div class="header">
  <h2 style="color:#226853;font-size: 50px;"><i><b>It's time to make like SpongeBob and get in touch with your feelings</b></i></h2>
</div>
        ...
        <section>
             <div class="wrapper">
                <div class="row">
                     ...
                     <?php 
                          global $con;
                          $get_page="select * from shophomek";
                          $run_page=mysqli_query($con, $get_page);
                          while ($row_page=mysqli_fetch_array($run_page)) {
                              # code...
                             $disc=$row_page['disshopk'];
                            
                            $title =$row_page['titleshopk'];
                            $post_id =$row_page['post_idshopk'];
                            $image =$row_page['imgshopk'];
                            $taka =$row_page['tkshopk'];
                  ...
                  <div class="max">
                           <div class="box_one">
                          <div class="col-12 col-m6 col-l9 photo"><img src="../rannaghara/admin/<?php echo $row_page["imgshopk"]; ?>" alt="" width="243" height="220" /></div>
