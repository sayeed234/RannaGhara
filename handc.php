...
<script type="text/javascript">
    function myOnClickbrk(ctrl){
       var cart = ctrl.getElementsByTagName('p')[0].innerHTML;
        alert('Confirm Cart?');
        window.location.href = "shop_hand_cart.php?shophand_cart=" + cart;
...
?>
    ...
    <head>
        <title>rannaghra shop home</title>
        ...
        <section>
            <div class="wrapper">
              ...
              <div class="col-12 col-m6 col-l3 header_bottom_height">
                  ...
                  <div class="header">
  <h2 style="color:#226853;font-size: 50px;"><i><b>A handicraft sometimes more precisely expressed as artisanal handmade</b></i></h2>
...
<div id="navbar">
  ...
  <a class="active"href="handc.php">Handicraft</a>
        ...
        <section>
             <div class="wrapper">
                <div class="row">
                     ...
                     <?php 
                          global $con;
                          $get_page="select * from shophomeha";
                          $run_page=mysqli_query($con, $get_page);
                          while ($row_page=mysqli_fetch_array($run_page)) {
                              # code...
                             $disc=$row_page['disshopha'];
                            
                            $title =$row_page['titleshopha'];
                            $post_id =$row_page['post_idshopha'];
                            $image =$row_page['imgshopha'];
                            $taka =$row_page['tkshopha'];
                  ...
                  <div class="max">
                           <div class="box_one">
                          <div class="col-12 col-m6 col-l9 photo"><img src="../rannaghara/admin/<?php echo $row_page["imgshopha"]; ?>" alt="" width="243" height="220" /></div>
