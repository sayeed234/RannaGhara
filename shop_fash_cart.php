<?php
    ...
    $cart_product_id = $_GET['shopfash_cart'];
    header("Location: /rannaghara/fashion.php");
    ...
    if ($con) {
        ...
        if($count == 0){
            ...
            $check_cart_product_id = "SELECT * FROM  shophomef WHERE post_idshopf = '$cart_product_id'";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    $post_id =$row['post_idshopf'];
                    $title =$row['titleshopf'];
                    $taka =$row['tkshopf'];
