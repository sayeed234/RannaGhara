<?php
    ...
    $cart_product_id = $_GET['shophand_cart'];
    header("Location: /rannaghara/handc.php");
    ...
    if ($con) {
        ...
        if($count == 0){
            ...
            $check_cart_product_id = "SELECT * FROM  shophomeha WHERE post_idshopha = '$cart_product_id'";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    $post_id =$row['post_idshopha'];
                    $title =$row['titleshopha'];
                    $taka =$row['tkshopha'];
